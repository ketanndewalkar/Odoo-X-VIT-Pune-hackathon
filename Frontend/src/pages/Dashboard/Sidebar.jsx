...
export default function Sidebar() {
    return (
        <div className="w-64 bg-[#3d2437] text-white hidden md:flex flex-col p-4 border-r border-[#4a2c42]/50">
            <h1 className="text-xl font-bold mb-8 px-2 tracking-widest w-full text-center text-[#fff]">Odoo</h1>
...
function SidebarItem({ icon, label, to }) {
    return (
        <NavLink
            ...
            className={({ isActive }) =>
                `flex items-center gap-3 p-3 rounded-xl cursor-pointer transition-all duration-200 ${isActive
